...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DIRTY_RAW_IRON_BLOCK.get())
                ...
                .unlockedBy(getHasName(ModItems.DIRTY_RAW_IRON.get()), has(ModItems.DIRTY_RAW_IRON.get())).save(pRecipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BASIC_ALLOYER_BLOCK.get())
                ...
                .unlockedBy(getHasName(Items.BLAST_FURNACE), has(Items.BLAST_FURNACE)).save(pRecipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BASIC_TANK_BLOCK.get())
                ...
                .unlockedBy(getHasName(Items.DROPPER), has(Items.DROPPER)).save(pRecipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.IRON_NUGGET,3)
                ...
                .unlockedBy(getHasName(ModItems.ORES_POLISHER.get()), has(ModItems.ORES_POLISHER.get())).save(pRecipeOutput);
